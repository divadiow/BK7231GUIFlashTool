...
{
    // Kept source-compatible with BK7231Flasher/Utils/MiscUtils.cs.
    public class MiscUtils
    {
        ...
        internal static byte[] stripBinary(byte[] str) => throw new NotImplementedException();
        ...
        internal static uint ReadU32LE(byte[] b, int o = 0) =>
            (uint)(b[o] | (b[o + 1] << 8) | (b[o + 2] << 16) | (b[o + 3] << 24));

        internal static ushort ReadU16LE(byte[] buf, int o = 0) =>
            (ushort)(buf[o] | (buf[o + 1] << 8));

        internal static void WriteU32LE(byte[] buf, int offset, uint value)
        {
        ...
        internal static void WriteU16LE(byte[] buf, int offset, uint value)
        {
            buf[offset] = (byte)value;
            buf[offset + 1] = (byte)(value >> 8);
        }

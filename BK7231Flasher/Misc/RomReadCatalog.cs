...
namespace BK7231Flasher
{
    ...
    public static class RomReadCatalog
    {
        ...
        const string W800RomBackend = "W800_Stub cmd 0x98";
        const string W800RomController = "raw CPU memory via XMODEM";
        static readonly int[] W800SerialBauds = new int[] { 115200, 460800, 921600, 1000000, 2000000 };
        #endregion
        ...
        static readonly IReadOnlyList<RomReadTarget> Targets = new List<RomReadTarget>()
        {
            ...
            new RomReadTarget(BKType.W800, RomReadKind.Rom, "Mask ROM", 0x00000000, 0x5000, 921600, W800SerialBauds, W800RomSpace, W800RomBackend, W800RomController),
